    ...
    <PageLayout>
      <main className="space-y-8 fade-in">
        <article className="prose prose-gray article-section">
          ...
          <h2>Problem</h2>
          <p>
            In late 2023, vetarinary staff on Ascend were missing crucial detail
            of a pet's behavioural issue before and during client clinic visits.
            The existing behavioural notes feature on Ascend was suppressed at
            key points of their workflow, leading to safety risks and disruption
            at the clinic.
          </p>
          <h2>Outcome</h2>
          <p>
            From observations, maintaining focus within the software's context
            during a vet's workflow was important for busy vets and staff. This
            insight led to a comprehensive update of Ascend's scheduling user
            flows and patient details component. These updates helped in
          ...
          <div className="pt-8">
            <div className="p-4 bg-gray-100 rounded-lg text-center">
              <span>Skip to</span>
              <a href="#Research" className="article-nav-link">
                Research
              </a>
              ,
              <a href="#Wireframes" className="article-nav-link">
                Wireframes
              </a>
              ,
              <a href="#Prototype" className="article-nav-link">
                Prototype
              </a>
              , or
              <a href="#Reflections" className="article-nav-link">
                Reflections
              </a>
            </div>
          </div>
        ...
        <article className="prose prose-gray article-section" id="Research">
          ...
          <h1>Research</h1>
          <p>
            This UX improvement was prioritised because of the votes it received
            on Pendo in total. Initially, customers requested for pop-ups to
            appear to warn them of pets with behavioural issues.
          </p>
          <p>
            We also knew that these behavioural notes were important in ensuring
            safety as well as avoiding chaos at reception. It was common
            practice for some clinics to administer treatment to pets with
            behavioural issues at the carpark for minimal disruption to other
            clients.
          </p>
          <p>
            For a better understanding of Covetrus software's context of use, I
            visited two clinics:
          </p>
          <ul>
          ...
          <p>
            ...
            Specific triggers of the pet or their preferred handling techniques
            were often captured in the behaioural notes to help other staff
        ...
        <article className="prose prose-gray article-section" id="Wireframes">
          <h1>Wireframes</h1>
          <p>
            I initially sketched the pop-up alerts customers were asking despite
            evidence that it was unlikely to be the best solution. Thankully,
            Erin nudged me towards my other idea that could be consistently
            applied across all types of patient headers found in the product. It
            was an expandable "ribbon" that revealed the patient's notes when
            clicked.
          </p>
          <p>
        ...
        <article className="prose prose-gray article-section" id="Reflections">
          <h1>Reflections</h1>
          <p>
          ...
          <p>
            ...
            expanding this initiative's scope. I eventually landed on a solution
            that was a mix of what the users asked for and what I thought was
            best for their needs.
          </p>
          <p>
            When I first started sketching solutions, I stuck to what the users
            asked for because of a solution-taker mindset. It was an irrational
            fear of challenging initial assumptions to propose different
            solutions. I'm glad the team at Covetrus encouraged me to try other
            ideas, leading me on a journey of shedding that mindset.
          </p>
        </article>
        <p className="text-sm text-gray-500 italic border-t border-gray-200 mt-8 pt-4">
          A practical example of how user-centered design can enhance workplace
